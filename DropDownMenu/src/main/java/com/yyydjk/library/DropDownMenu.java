...
public class DropDownMenu extends LinearLayout {
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        relativeLayout.setLayoutParams(new LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
       ...
       // tab.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        tab.setPadding(dpTpPx(5), dpTpPx(12), dpTpPx(8), dpTpPx(12));
        //添加点击事件
        ...
        tabMenuView.addView(relativeLayout);
        //添加分割线
    ...
    public void setTabClickable(boolean clickable) {
        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
            (((RelativeLayout)(tabMenuView.getChildAt(i)))).getChildAt(0).setClickable(clickable);
        }
    }
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            ((TextView) (((RelativeLayout)(tabMenuView.getChildAt(current_tab_position)))).getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(null, null,
    ...
    private void switchMenu(View target) {
        ...
        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
            if (target == (((RelativeLayout)(tabMenuView.getChildAt(i)))).getChildAt(0)) {
                if (current_tab_position == i) {
                    ...
                    ((TextView) (((RelativeLayout)(tabMenuView.getChildAt(i)))).getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(null, null,
